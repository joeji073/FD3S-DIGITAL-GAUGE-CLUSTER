...
while(screenTrack == 0) {
    ...
    reading();
      ...
      GD.Vertex2ii(3,12,3);
      GD.ColorRGB(RED);
      GD.cmd_gauge(118,125,130,12544,9,5,1170,1000);

      GD.ColorRGB(WHITE);
      GD.Begin(BITMAPS);
      GD.Vertex2ii((118-18), (125-18), 2);   // Needle center asset, the 2 might need to change
...
while(screenTrack == 1) {           //Analog Fuel pressure gauge
  ...
  GD.Begin(BITMAPS);
  GD.Vertex2ii(3,12,3);  //Will need to add image handle once assets are loaded (x,y,image handle)

  GD.ColorRGB(RED);
  GD.cmd_gauge(118,125,130,12544,9,5,(map(canData.CFUELP, 0, 120,1170, 2170)),1000); //fuel pressure gauge needle
  ...
  GD.ColorRGB(WHITE);
  GD.printNfloat(190, 138, canData.CFUELP, 0, NUMBERFONT_HANDLE); //fuel pressure number
...
while(screenTrack == 100) {           //Digital fuel pressure
  ...
  GD.ColorRGB(WHITE);
  GD.cmd_number(110, 150, 1, OPT_CENTER, canData.CFUELP);
...
while(screenTrack == 2) {           //Analog Fuel Temp gauge
  ...
  GD.ColorRGB(RED);
  GD.cmd_gauge(118,125,130,12544,9,5,(map(GFUELT, 40, 160,1170, 2170)),1000); //main gauge needle
  ...
  GD.ColorRGB(WHITE);
  GD.printNfloat(190, 140, canData.CFUELTEMP, 0, 0); //Speedo numbers
  ...
  GD.ColorRGB(WHITE);
  GD.cmd_number(110, 150, 1, OPT_CENTER, canData.CFUELTEMP);
...
while(screenTrack == 3) {           //Analog Oil Temp Gauge
  ...
  GD.ColorRGB(RED);
  GD.cmd_gauge(118,125,130,12544,9,5,(map(GOILT, 100, 220,1170, 2170)),1000); //main gauge needle
  ...
  GD.ColorRGB(WHITE);
  GD.printNfloat(190, 140, canData.COILTEMP, 0, 0); //Speedo numbers
  ...
  GD.ColorRGB(WHITE);
  GD.cmd_number(110, 150, 1, OPT_CENTER, canData.COILTEMP);
...
while(screenTrack == 4) {           //Analog Air temp gauge
  ...
  GD.ColorRGB(RED);
  GD.cmd_gauge(118,125,130,12544,9,5,(map(GMAT, 60, 180,1170, 2170)),1000); //main gauge needle
  ...
  GD.ColorRGB(WHITE);
  GD.printNfloat(190, 140, canData.CMAT, 0, 0); //Speedo numbers
  ...
  GD.ColorRGB(WHITE);
  GD.cmd_number(110, 150, 1, OPT_CENTER, canData.CMAT);
...
while(screenTrack == 5) {           //Digital Ethanol Content Gauge
  ...
  GD.ColorRGB(WHITE);
  GD.cmd_number(110, 150, 1, OPT_CENTER, canData.CETHL);
...
while(screenTrack == 6) {           //Digital Battery Gauge
  ...
  GD.ColorRGB(WHITE);
  GD.printNfloat(125, 117, GBATT, 1, 1);
...
while(screenTrack == 7) {           //Digital EGO Correction gauge
  ...
  GD.ColorRGB(WHITE);
  GD.cmd_number(110, 150, 1, OPT_CENTER, canData.CEGOCOR);
...
while(screenTrack == 8) {           //Digital Total fuel correction gauge
  ...
  GD.ColorRGB(WHITE);
  GD.cmd_number(110, 150, 1, OPT_CENTER, canData.CTOTCOR);
...
while(screenTrack == 9) {           //Digital Ign Advance
  ...
  GD.ColorRGB(WHITE);
  GD.cmd_number(110, 150, 1, OPT_CENTER, canData.CIGNADV);
...
while(screenTrack == 10) {           //MPG gauge
  ...
  GD.ColorRGB(WHITE);
  GD.cmd_number(110, 150, 1, OPT_CENTER, canData.CMPG);
